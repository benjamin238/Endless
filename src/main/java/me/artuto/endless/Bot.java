...
public class Bot extends ListenerAdapter
{
    ...
    void boot(boolean dataEnabled, boolean maintenance) throws LoginException, SQLException
    {
        ...
        clientBuilder.setOwnerId(String.valueOf(config.getOwnerId()))
                ...
                // Music
                new ForceSkipCmd(this), new NowPlayingCmd(), new PauseCmd(this), new PlayCmd(this), new ResumeCmd(this),
                ...
                new ServerSettingsCmd(this), new SetDJCmd(this), new SetupCmd(this), new StarboardCmd(this), new WelcomeDmCmd(this),
